	    	...
	    	x=1;
	    			while(x==1){
						...
						if (choice.equals("1")){
	    					...
	    					System.out.println("***************************************");
							System.out.println("** 1.)SALEM        | 41rs   |   "+available[1]+"   **");
	    					System.out.println("** 2.)RASIPURAM    | 34rs   |   "+available[2]+"   **");
										...
										if(search.equalsIgnoreCase(ticketS[b][0])){
											...
											if(ticketS[b][2].equals("x")){
		    									...
		    									while(x==1){
		    										...
		    										pay[b] = Double.parseDouble(s.nextLine());
